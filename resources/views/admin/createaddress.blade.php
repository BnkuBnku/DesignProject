          ...
          <div class="col-xl-10">
                <div class="card">
                    <div class="card-header row ">
                        ...
                        <a class="text-right col " style="font-size:22px; color:red;" href="{{ route('resort') }}">Back</a>
                    </div>
                </div> 
                <div class="card">
                        ...
                        <form action="{{ route('create.post') }}" method="POST">
                            ...
                            @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="text" id="ResortName" class="form-control" name="Resort_name" style="margin-left:80px" value="" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="text" id="ResortAdd" class="form-control" name="Resort_Address" style="margin-left:61px" value="" required >
                                ...
                                <div class="form-group row">
                                    <label for="ResortUrlPic" class="row-md-4 row-form-label text-md-left" style="font-size: 20px">Resort Picture Url</label>
                                    <div class="col-md-10 ">
                                        <input type="text" id="ResortUrlPic" class="form-control" name="resort_pic_url" style="margin-left:40px" value="" required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="text" id="Latitude" class="form-control" name="ResortLatitude_Coor"  style="margin-left:20px" value="" required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="text" id="Longitude" class="form-control" name="ResortLongitude_Coor"  value="" required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="Services" class="form-control" name="Services" style="margin-left: 124px"    value="" required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="Cottages" class="form-control" name="Cottages" style="margin-left: 120px" value=""  required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="Essentials" class="form-control" name="Essentials" style="margin-left: 112px"  value="" required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="PerStay" class="form-control" name="PerStay" style="margin-left: 70px" value=""  required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="PerAdult" class="form-control" name="PerAdult" style="margin-left: 126px" value=""  required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="PerChild" class="form-control" name="PerChild" style="margin-left: 126px"   value="" required >

                        ...
                        <form action="{{ route('save') }}" method="POST">
                            ...
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="text" id="Latitude" class="form-control" name="ResortLatitude_Coor"  style="margin-left:20px" value="{{ $resort[0]->ResortLatitude_Coor }} "required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="text" id="Longitude" class="form-control" name="ResortLongitude_Coor" value="{{ $resort[0]->ResortLongitude_Coor }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="text" id="ResortAdd" class="form-control" name="Resort_Address" style="margin-left:61px" value="{{ $resort[0]->Resort_Address }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="Services" class="form-control" name="Services" style="margin-left: 124px"  value="{{ $resort[0]->Services }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="Cottages" class="form-control" name="Cottages" style="margin-left: 120px"  value="{{ $resort[0]->Cottages }}"required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="Essentials" class="form-control" name="Essentials" style="margin-left: 112px"  value="{{ $resort[0]->Essentials }}"required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="PerStay" class="form-control" name="PerStay" style="margin-left: 70px" value="{{ $resort[0]->PerStay }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="PerAdult" class="form-control" name="PerAdult" style="margin-left: 126px" value="{{ $resort[0]->PerStay }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 ">
                                        <input type="number" id="PerChild" class="form-control" name="PerChild" style="margin-left: 126px"  value="{{ $resort[0]->PerChild }}" required autofocus>
